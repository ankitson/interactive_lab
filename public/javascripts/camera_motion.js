...
function lightOn()
{
  jQuery.getJSON("http://www.iobridge.com/widgets/static/id=OXO0Q9H2yXME&value=0&format=json&callback=?", function(json) { alert(json.value); });
...
function lightOff()
{
	jQuery.get("http://www.iobridge.com/widgets/static/id=OXO0Q9H2yXME&value=1&format=json&callback=?", function(json) { alert (json.value); });
